...
.. code:: bash
   ...
   g++ combustor.cpp -o combustor -pthread -O3 -std=c++0x -I/opt/cantera-2.5.0/include -L/opt/cantera-2.5.0/lib -lcantera -lsundials_cvodes -lsundials_ida -lsundials_nvecserial
