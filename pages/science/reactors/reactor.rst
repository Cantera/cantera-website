.. title: Deriving Reactor Governing Equations
.. has_math: true
...
.. jumbotron::
   ...
   .. raw:: html
      ...
      <h1 class="display-3">Deriving Reactor Governing Equations</h1>

   .. class:: lead

      This guide shows you how to derive the governing equations used to define a Standard Reactor

Standard Reactor
****************

A standard Reactor is defined by the four state variables: 
